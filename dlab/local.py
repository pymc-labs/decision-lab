...
def build_local_prompt(prompt: str, config: dict[str, Any], work_dir: str | None = None) -> str:
    ...
    system_instructions: str = (
        ...
        f"`PYTHONPATH={work_dir_abs}/_docker:$PYTHONPATH python my_script.py`\n\n"
        ...
        f"- The absolute path to the correct python binary (e.g., `{work_dir_abs}/.venv/bin/python`)\n"
        f"- The correct PYTHONPATH value (e.g., `PYTHONPATH={work_dir_abs}/_docker:$PYTHONPATH`)\n"
